...
Route::prefix('admin')->name('admin.')->middleware('auth')->group(function (): void {
    ...
    Route::get('/devices', [DeviceController::class, 'index'])->middleware('permission:view-devices,manage-devices')->name('devices');
    Route::get('/devices/{device}', [DeviceController::class, 'show'])->middleware('permission:view-devices,manage-devices')->name('devices.show');
    Route::get('/devices/{device}/locations', [DeviceController::class, 'locations'])->middleware('permission:view-devices,manage-devices')->name('devices.locations');
    Route::get('/devices/{device}/latest-location', [DeviceController::class, 'latestLocation'])->middleware('permission:view-devices,manage-devices')->name('devices.latest-location');
    Route::patch('/devices/{device}/enable-tracking', [DeviceController::class, 'enableTracking'])->middleware('permission:manage-device-tracking,manage-devices')->name('devices.enable-tracking');
    Route::patch('/devices/{device}/enable-active-search', [DeviceController::class, 'enableTracking'])->middleware('permission:manage-device-tracking,manage-devices')->name('devices.enable-active-search');
    Route::patch('/devices/{device}/disable-tracking', [DeviceController::class, 'disableTracking'])->middleware('permission:manage-device-tracking,manage-devices')->name('devices.disable-tracking');
    Route::patch('/devices/{device}/recovered', [DeviceController::class, 'markRecovered'])->middleware('permission:manage-device-tracking,manage-devices')->name('devices.recovered');
    Route::patch('/devices/{device}/mark-recovered', [DeviceController::class, 'markRecovered'])->middleware('permission:manage-device-tracking,manage-devices')->name('devices.mark-recovered');
